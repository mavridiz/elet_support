                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                <div class="sm:flex-auto">
                                    ...
                                    <p class="mt-2 text-sm text-gray-700">Aquí se mostrará el reporte seleccionado para su verificación y asignarlo a un ingeniero de mantenimiento</p>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="sm:flex-auto">
                                                            <h1 class="text-xl font-semibold text-gray-900">Asignación de reporte</h1>
                                                            <p class="mt-2 text-sm text-gray-700">En este apartado se selecciona el area donde se mandará el reporte</p>
                                                        </div>

                                                        <div>
                                                            <label for="area">Área que va dirigido el reporte:</label><br><br>
                                                            <button type="button" name="area" value="Mantenimiento" >
                                                                <a href="rep_eng_mm.jsp?id_case=<%= ids%>" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Ingeniero de Mantenimiento</a>
                                                            </button>
                                                            <button type="button" name="area" value="Soporte">
                                                                <a href="rep_man_mm.jsp?id_case=<%= ids%>" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Gerente de Soporte</a>
                                                            </button>
