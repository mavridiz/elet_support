                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="sm:flex-auto">
                                                            ...
                                                            <p class="mt-2 text-sm text-gray-700">En este apartado se asigna a un ingeniero de mantenimiento</p>
                                                        </div>

                                                        <%
                                                            PreparedStatement ps2 = conn.prepareStatement("SELECT id_user,user_name FROM tbl_users INNER JOIN tbl_admin_rol ON tbl_users.id_user = tbl_admin_rol.admin_id WHERE tbl_admin_rol.rol = 'IngenieroM';");
                                                            ResultSet rs2 = ps2.executeQuery();
                                                            if (!rs2.isBeforeFirst()) {
                                                        %>
                                                        <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 p-5">No existen ingenieros de mantenimiento registrados</h1>
                                                        <%
                                                        } else {
                                                            while (rs2.next()) {
